...
class OwnerDAO {
  ...
  def insertOwners(owners: Array[Owner]): Unit = withSession {
    val tuples: Array[(Long, String, Int, String, String, Date, String, String)] = owners map (o => {
      val t: (Long, String, Int, String, String, Date, String, String) = Owner.unapply(o).get
